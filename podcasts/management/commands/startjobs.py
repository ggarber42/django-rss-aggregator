...
PLACE_HOLDER_IMG = "https://images.emojiterra.com/twitter/v14.0/512px/1f4f0.png"
...
def save_new_episodes(feed):
    ...
    podcast_image = feed.channel.image["href"] if "image" in feed.channel else PLACE_HOLDER_IMG
...
def fetch_talkpython_episodesx():
    """Fetches new episodes from RSS for the Talk Python to Me Podcast."""
    _feed = feedparser.parse("https://www.economist.com/international/rss.xml")
    save_new_episodes(_feed)
